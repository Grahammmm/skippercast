...
| [NOAA Geo-Polar Blended SST](https://coastwatch.noaa.gov/cwn/products/noaa-geo-polar-blended-global-sea-surface-temperature-analysis-level-4.html) | Daily night-only Level 4 surface-temperature analysis at 0.05° (~5 km), with source date, land/ice mask and analysis error. | Interpolated surface analysis, not independent 5 km observations, bottom temperature or fish presence. The older JPL MUR binding remains historical research context while its West Coast distribution endpoint is unavailable. |
| [NOAA two-sensor VIIRS near-real-time ocean color](https://coastwatch.noaa.gov/cwn/products/noaa-msl12-ocean-color-near-real-time-viirs-single-sensor-snpp-and-noaa-20.html) | Daily Level 3 merged OCI chlorophyll at 0.0375° (~4 km), with original valid cells and source time. | Surface phytoplankton proxy, not bait density. Cloud and quality gaps remain missing; no gap filling or nearest-valid-cell substitution. The older Aqua MODIS binding remains historical research context. |
| [NOAA IOOS/HFRNet radar currents via NDBC THREDDS](https://ioos.noaa.gov/project/hf-radar/) | Latest advertised hourly 6 km West Coast vector grid, contributing-radar count and geometric uncertainty indicator; source time and nominal depth retained. | Require at least two contributing radars. The current nominal surface depth is about 1.4 m; it is not bottom drift or bar current. Daily collection means a sample can age out during the day. [CeNCOOS explains the radar network](https://www.cencoos.org/observations/sensor-platforms/hf-radar/). |
