...
| Bottom | 132 Central Coast point candidates, 11 survey-qualified Southern island reef patches in partial packages, and 43 generalized Cape Mendocino **context-only** polygons; northern fishing targets remain unpublished | Inspect local native grids/datum and substrate, then qualify depth and exclusions. Never turn all survey leads into spots. |
