...
The Bodega–Point Reyes preview displays 17 larger historical hard-bottom outlines selected from the [original NOAA/USGS terrain review](../dist/data/bodega-native-hard-terrain-review.json). The review has 74 local outlines: 56 are too small for its terrain ranking, 18 receive only an uncalibrated C habitat grade, and one of those 18 is held near a selected chart-danger feature. The 17 displayed outlines retain their original survey citations and terrain relief but show **no fishing quality grade, fish-presence claim or chartplotter export**. Their survey-component depth ranges are deliberately not presented as polygon-specific depths. Current chart, approach route, legal date/method and independent species evidence still gate fishing-target promotion.
