...
- [USGS OFR 03-85](https://pubs.usgs.gov/of/2003/0085/) and [OFR 2005-1170](https://pubs.usgs.gov/of/2005/1170/catalog.html) contain valuable habitat polygons and 1 m sidescan for San Miguel, Anacapa and southeast Santa Cruz, supported by selected diver/ROV observations. The metadata describes roughly 10 m position uncertainty. The original data host returned 403 during this review, so those polygons were not claimed as imported. A 1 m backscatter pixel is not a 1 m depth cell or boulder measurement.
