...
1. Continue with adjoining original BAGs. H13322, H13324 and H13325 are explicitly held in `catalog/noaa-survey-lead-holds.json`. H13322's report lists three new obstructions; H13325's report says the western navigable-area limit and most features there were not investigated. H13324's original 2019 MLLW BAG has 14.2 million native fine cells. A separate research trial, using a 60–200 ft band and refreshed official closure geometry, identified eight candidate patches (one B, seven C). Its report identifies two survey holidays and steep nearshore rocks, so those coordinates remain unpublished. Obtain exact feature positions, reconcile a current ENC, and clip unresolved areas before considering any of these surveys for public targets.
2. Santa Barbara Island's original H13201 survey yielded one B-grade research patch under a 4 m native-footprint erosion, but that patch fell to C after a 50 m erosion and disappeared after 100 m. The survey report describes nearshore holidays, rocky and kelp-limited coverage, and dangerous waves. H13201 is held; the more robust parts did not currently justify a new high-quality fishing target. `scripts/refresh_enc_hazards.py` snapshots all 18 danger layers across NOAA's harbor, approach and coastal ENC Direct services for a bounded regional scope. Its source receipts and full charted-feature geometries support future reviews, but an empty query or a distant charted rock is not proof of a safe route or a complete hazard inventory.
   The H13209 East Santa Cruz Channel original survey produced only two C-grade patches after a 50 m support erosion. Its report notes an underwater rock, kelp, an acoustic-shadow holiday and a charted-feature correction; that survey is held too. These source audits preserve the distinction between measured depth, plausible habitat, and a fishing recommendation.
   The adjoining [H13210 North-Central Santa Cruz survey](https://www.ngdc.noaa.gov/nos/H12001-H14000/H13210.html) produced one 0.634 ha C-grade candidate (score 27) after the same 50 m inward support screen. The [original report](https://data.ngdc.noaa.gov/platforms/ocean/nos/coast/H12001-H14000/H13210/DR/H13210_DR.pdf) identifies two unfilled holidays, including an acoustic shadow from rocky seabed, and a 1.6 m underwater rock that may endanger vessels approaching shore. It required no bottom samples. H13210 is also held; its research-only coordinate is not published or exported. Exact gap/feature positions, present chart hazards, stronger substrate evidence and local rules remain to be reconciled.
3. Import geographically matched seabed samples and georeferenced camera/ROV observations. Record sampling footprint, dates and classification confidence. The inaccessible older USGS sidescan catalogs remain leads until actual files and metadata can be verified.
4. Review the original NOAA backscatter mosaics as a separate variable, with acquisition frequency, processing and ground truth. Brightness alone is not a rock class.
5. Add species-specific depth/substrate evidence and observations with effort and zero catches. Do not turn occurrence points, charter schedules or general species preferences into a calibrated local bite score.
