...
The [complete target ranking inventory](../dist/data/central-rocky-species-rankings.json) uses the existing deterministic lingcod and broad rockfish physical-habitat fit rule. Rank **1** means stronger mapped fit, **2** intermediate, **3** lower. Lingcod weights local relief more; rockfish weights rough-habitat extent more. The existing thresholds give 105/18/9 targets in lingcod ranks 1/2/3 and 116/9/7 in rockfish ranks 1/2/3. This is a coarse grouping, so the 0–100 terrain score and source detail remain important within rank 1. No score is a catch probability or evidence of fish at the coordinate.
