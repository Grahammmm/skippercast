...
export function detailHTML({
  ...
  return `${requested ? `<p class="small">Selected ${esc(requested.label || "map location")}: nearest requested forecast sample is ${num(distanceNm(requested, p))} nm away. Values are regional, not reef-scale.</p>` : ""}
    ...
    <section class="marine-card"><h3>Before you go</h3><p>Inspect the full trip, including the return. A pleasant hour at a fishing spot does not establish a comfortable passage or safe entrance.</p><div class="forecast-links"><a href="https://forecast.weather.gov/MapClick.php?TextType=2&zoneid=PZZ645" target="_blank" rel="noopener">NWS coastal forecast ↗</a><a href="https://forecast.weather.gov/MapClick.php?TextType=2&zoneid=PZZ670" target="_blank" rel="noopener">NWS offshore forecast ↗</a><a href="https://www.ndbc.noaa.gov/station_page.php?station=46215" target="_blank" rel="noopener">Live Diablo Canyon buoy ↗</a><a href="https://www.morrobayca.gov/133/Harbor" target="_blank" rel="noopener">Morro Bay Harbor ↗</a><a href="https://wildlife.ca.gov/Fishing/Ocean/Regulations/Fishing-Map/Central" target="_blank" rel="noopener">Current fishing rules ↗</a></div><p class="small">Daily buoy samples appear in the recent fishing-evidence panel. Live entrance conditions are not loaded here. Active-alert checks do not cover unissued warnings later in the forecast.</p></section>
