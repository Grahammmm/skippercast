...
import { readConditions, tideAt, HOUR, POINTS } from "./marine-data.js?v=8.8";
import { esc, num, from, local, weatherName } from "./marine-charts.js?v=8.8";
import { rateHour } from "./morning-outlook.js?v=8.8";
