...
import {loadCoasts,coastForPackage,initCoastSelector,initCoastalContext} from './coasts.js?v=8.13';
...
try {
  ...
  if(requested) {
    ...
    const {initCoastalDiscovery}=await import('./coastal-discovery-v3.js?v=8.17');
