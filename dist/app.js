import {initTripAlerts} from './trip-alerts.js?v=8.10';
import {initExport} from './export-ui.js?v=8.10';
import {mountSpotEvidence} from './spot-evidence.js?v=8.10';
import {initIntelligence} from './intelligence.js?v=8.10';
import {initHabitatDynamics} from './habitat-map.js?v=8.10';
import {terrainSource,terrainMetricsHTML} from './terrain-evidence.js?v=8.10';
let tripExport;
import { getRegion, assetURL } from "./region.js?v=8.10";
import { mountBottom } from "./bottom-view.js?v=8.10";
import { initSurveyHabitat } from "./survey-habitat.js?v=8.10";
import { initRegionalContext } from "./regional-context.js?v=8.10";
import { initGeology } from "./geology.js?v=8.10";
import { initWeather } from "./weather-ui.js?v=8.10";
import { initNavigation } from "./navigation.js?v=8.10";
import { initChart } from "./chart-map.js?v=8.10";
import { initSpecies, matchesSpecies } from "./species.js?v=8.10";
import { initRegulations } from "./regulations.js?v=8.10";
import { initLocationContext, viewFromURL } from './location-context.js?v=8.10';
import { initCharterGrounds } from "./charter-grounds.js?v=8.10";
import { initProtectedAreas } from "./protected-areas.js?v=8.10";
import { initDriftGuides } from "./drift-guides.js?v=8.10";
import { initCommercialAIS } from "./commercial-ais.js?v=8.10";
