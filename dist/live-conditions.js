import { getRegion, acceptsFeed, localContext, assetURL } from "./region.js?v=8.9";
import { fetchJSON, compass } from "./forecast.js?v=8.9";
import { esc, num, local, from } from "./marine-charts.js?v=8.9";
