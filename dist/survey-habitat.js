...
import {assetURL,getRegion} from './region.js?v=8.10';
import {esc} from './marine-charts.js?v=8.10';
import {habitatGroups} from './map-response.js?v=8.10';
import {positions} from './geo-screen.js?v=8.10';
...
export async function initSurveyHabitat(map, screen, onSelect, onFocus=()=>{}) {
  ...
  try{
    worker=new Worker(new URL('./habitat-screen-worker.js?v=8.10',import.meta.url),{type:'module'});
