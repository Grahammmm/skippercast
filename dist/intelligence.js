import {getRegion,localContext} from './region.js?v=8.6';
import {esc,num,from,local} from './marine-charts.js?v=8.6';
import {readConditions,angleBetween,distanceNm} from './marine-data.js?v=8.6';
...
export function verificationHTML(data) {
  ...
  const summary=v.summary, groups=v.groups||[],pairs=v.comparisons||[];
