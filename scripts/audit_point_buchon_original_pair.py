...
def fetch_original(leads, bathy, character, metadata):
...
def aggregate(bathy_zip, class_zip, class_metadata, rov_csv, rov_pin):
    ...
    return {"schema_version": 1, "scope": "point-buchon-original-paired-200-300ft-research",
            ...
            "native_grid_resolution_m": 2, "native_depth_datum": "unresolved",
...
def main():
    ...
    if args.fetch:
        ...
        fetch_original(leads, args.bathy, args.character, args.character_metadata)
        fetch_rov(pin, args.rov)
    report = aggregate(args.bathy, args.character, args.character_metadata, args.rov, pin)
