...
| --- | --- | --- |
| Interactive map | Filter all 132 public targets, inspect notes and geometry, export a selected target to GPX, and compare live wind/wave evidence at three offshore samples. | [Web app guide](docs/web-app.md) |
