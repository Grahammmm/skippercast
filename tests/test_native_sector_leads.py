...
class NativeSectorLeadsTest(unittest.TestCase):
    def test_catalog_survey_outside_sector_does_not_count_as_grid(self):
        audit = {
            ...
            'max_bytes': 100000000, 'file_count': 2, 'inspected_count': 2,
        ...
        self.assertEqual(row['audited_bag_files_associated_with_surveys'], 2)
        self.assertEqual(row['georeferenced_bag_bboxes_intersecting_sector'], 1)
